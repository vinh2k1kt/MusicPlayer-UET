...
import com.example.music_player_svmc.Dialog.AddToPlaylistDialog;
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    switch (menuItem.getItemId()) {
                        ...
                        case R.id.removeSong:
                            ...
                            String name = playlists.get(playlistID).getPlaylistName();
                            MusicPlayerApp.dbHelper.removeSongInPlaylist(song, name);
